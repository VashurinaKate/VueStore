      ...
      <div class="header__left">
        ...
        <nav class="header__right">
            <div class="side-menu-wrap">
                <div class="side-menu"><svg class="burger header__icons" width="32" height="23" viewBox="0 0 32 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 23V20.31H32V23H0ZM0 12.76V10.07H32V12.76H0ZM0 2.69V0H32V2.69H0Z" fill="#E8E8E8"/>
                    </svg>
                </div>
                <side-menu v-if="activeSideMenu"></side-menu>
            </div>
            <router-link :to="{name: 'Registration'}" class="header__icons"><svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default {
  ...
  methods: {
    // showSideMenu() {
    //   return this.activeSideMenu ? true : false
    // }
  },
  // computed: {
