<template>
    <header class="header center">
      <div class="header__left">
        <router-link :to="{name: 'iMain'}"><svg width="44" height="38" viewBox="0 0 44 38" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                </defs></svg><span style="color:white">{{sitename}}</span></router-link>
        ...
        <nav class="header__right">
            <details>
                <summary><svg class="burger header__icons" width="32" height="23" viewBox="0 0 32 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="registration.html" class="header__icons"><svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <router-link
              active-class="active"
              :to="{name: 'Cart'}"
              class="header__icons cart-icon"><svg width="33" height="29" viewBox="0 0 33 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                </svg><div class="cartItemCount">{{ $store.state.shoppingCart.cartCount }} </div></router-link>
        </nav>
    </header>
</template>
