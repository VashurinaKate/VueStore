    ...
    <section class="registration center">
        <div class="registration__left">
            <form action="#" class="registration__form">
                ...
                <input type="text" class="registration__input" id="name" placeholder="First Name" required>
                <input type="text" class="registration__input" placeholder="Last Name" required>
                <input type="radio" class="radio" name="sex" id="male" required><label for="male">Male</label>
                <input type="radio" class="radio" name="sex" id="female" required> <label for="female">Female</label>
                <label for="email">Login details</label>
                <input type="email" id="email" class="registration__input" placeholder="Email" required>
                <input type="password" class="registration__input" placeholder="Password" required>
                <p class="registration__helptext">Please use 8 or more characters, with at least 1 number and a mixture of uppercase and lowercase letters</p>
                <button type="submit" class="btn btn--main">JOIN NOW
